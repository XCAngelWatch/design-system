  ...
  <div class="subsection">
    ...
    <table class="map-table">
      ...
      <tbody>
        ...
        <tr><td><b>Popconfirm</b></td><td><span data-i18n="feedback:text.032">行内可逆操作 —— 启停 / 重置缓存</span></td><td><span data-i18n="feedback:text.033">是（行内）</span></td><td><span data-i18n="feedback:text.034">用户确认或取消</span></td><td><span data-i18n="feedback:text.035">影响范围 = 1 条且结果可恢复；附在触发按钮旁</span></td></tr>
