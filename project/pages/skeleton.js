/* AngelWatch Design System — page: skeleton (auto-generated from HTML fragment) */
...
<div style="display:flex;flex-direction:column;gap:14px">
  ...
  <div class="skel"></div>
  <div class="skel"></div>
  <div class="skel mid"></div>
  <div style="height:1px;background:var(--aw-border-3);margin:6px 0"></div>
  ...
  <div class="subsection"><h3><span data-i18n="common:component.usedBy">页面蓝图使用场景</span></h3><div class="blueprint-notes"><span><a href="#/list-page">ListPage</a></span><span><a href="#/dash-page">DashboardPage</a></span></div></div>
</section>
</div>
`;
