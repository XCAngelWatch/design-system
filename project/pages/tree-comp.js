...
<div class="tree-comp">
  ...
  <div class="body">
    ...
    <div class="tnode depth-2" data-tree-expandable><div class="caret">›</div><div class="check"></div><svg class="ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="10" r="3"/><path d="M12 22s8-7 8-13a8 8 0 1 0-16 0c0 6 8 13 8 13z"/></svg><span class="lbl"><span data-i18n="tree-comp:text.011">杭州</span></span><span class="count">1,802</span></div>
    <div class="tnode depth-2" data-tree-expandable><div class="caret">›</div><div class="check"></div><svg class="ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="10" r="3"/><path d="M12 22s8-7 8-13a8 8 0 1 0-16 0c0 6 8 13 8 13z"/></svg><span class="lbl"><span data-i18n="tree-comp:text.012">南京</span></span><span class="count">1,081</span></div>
    <div class="tnode depth-1" data-tree-expandable><div class="caret">›</div><div class="check"></div><svg class="ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 9l9-6 9 6v12H3z"/></svg><span class="lbl"><span data-i18n="tree-comp:text.013">华北大区</span></span><span class="count">3,402</span></div>
    <div class="tnode depth-1" data-tree-expandable><div class="caret">›</div><div class="check"></div><svg class="ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 9l9-6 9 6v12H3z"/></svg><span class="lbl"><span data-i18n="tree-comp:text.014">华南大区</span></span><span class="count">2,816</span></div>
    <div class="tnode depth-1" data-tree-expandable><div class="caret">›</div><div class="check"></div><svg class="ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 9l9-6 9 6v12H3z"/></svg><span class="lbl"><span data-i18n="tree-comp:text.015">华西大区</span></span><span class="count">984</span></div>
  </div>
</div>
  ...
  <div class="subsection">
    ...
    <div class="tree-mode-grid">
      ...
      <div class="tm-card">
        ...
        <div class="tm-body">
          <div class="tree-comp">
            <div class="body" data-check-on-select>
