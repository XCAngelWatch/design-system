...
<div class="body"><span class="l">状态</span><span class="v"><span class="status-dot online">在线</span></span><span class="l">OTA</span><span class="l">所在组</span><span class="v">华东一区 / 仓配</span><span class="l">最后心跳</span><span class="v">12 秒前</span></div>
...
<div class="body"><span class="l">状态</span><span class="v"><span class="status-dot upgrading">升级中 · 64%</span></span><span class="l">OTA</span><span class="v">v3.4.1 → v3.4.2</span><span class="l">所在组</span><span class="v">华北二区 / 配送</span><span class="l">推送时间</span><span class="v">3 分钟前</span></div>
...
<div class="body"><span class="l">状态</span><span class="v"><span class="status-dot fault">故障 · 自检失败</span></span><span class="l">OTA</span><span class="l">所在组</span><span class="v">华南一区 / 仓配</span><span class="l">异常时间</span><span class="v">2 小时前</span></div>
...
<div class="body"><span class="l">状态</span><span class="v"><span class="status-dot offline">离线</span></span><span class="l">OTA</span><span class="l">所在组</span><span class="v">西南一区 / 仓配</span><span class="l">最后在线</span><span class="v">1 天 4 小时</span></div>
