...
<section class="section" id="data-cards">
  ...
  <h2>设备卡片 DataCard</h2>
  <p class="lede">仅 ListPage 表格视图无法满足现场调研：班组长在小屏（笔记本）下扫一排状态比扫表更高效。添加 DataCard 作为 ListPage 的第二种视图（顶部工具栏 <span class="mono">⊞ ☰</span> 切换）。状态色作为顶部色条而非整卡背景，避免视觉过载。</p>
...
<div class="body"><span class="l">状态</span><span class="v"><span class="status-dot online">在线</span></span><span class="l">OTA 版本</span><span class="v">v3.4.2</span><span class="l">所在组</span><span class="v">华东一区 / P5 设备组</span><span class="l">最后心跳</span><span class="v">12 秒前</span></div>
...
<div class="body"><span class="l">状态</span><span class="v"><span class="status-dot upgrading">升级中 · 64%</span></span><span class="l">OTA 版本</span><span class="v">v3.4.1 → v3.4.2</span><span class="l">所在组</span><span class="v">华北二区 / P5 设备组</span><span class="l">推送时间</span><span class="v">3 分钟前</span></div>
...
<div class="body"><span class="l">状态</span><span class="v"><span class="status-dot fault">故障 · 自检失败</span></span><span class="l">OTA 版本</span><span class="v">v3.4.1</span><span class="l">所在组</span><span class="v">华南一区 / P5 设备组</span><span class="l">异常时间</span><span class="v">2 小时前</span></div>
...
<div class="body"><span class="l">状态</span><span class="v"><span class="status-dot offline">离线</span></span><span class="l">OTA 版本</span><span class="v">v3.3.9</span><span class="l">所在组</span><span class="v">西南一区 / P8 设备组</span><span class="l">最后在线</span><span class="v">1 天 4 小时</span></div>
<div class="foot"><a>历史</a><a style="color:var(--aw-text-disabled);cursor:not-allowed">下发</a><a style="color:var(--aw-text-disabled);cursor:not-allowed">升级</a></div>
  ...
  <div class="subsection">
    ...
    <div class="bp-grid">
      ...
      <div class="bp-card"><h4>设备卡片</h4><p>用于设备管理和设备分组。主信息是设备名、SN、在线状态、所属机构；远程控制、日志、升级动作随状态启停。</p></div>
    </div>
