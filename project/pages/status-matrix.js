...
<section class="section" id="status-matrix">
  ...
  <p class="lede"><span data-i18n="status-matrix:text.003">设备在生命周期中会经历远多于"在线/离线"的状态：已下发指令但未激活、被锁定、维护中、已退役 …… 系统定义 8 种状态，每个状态有专属图形信号 + 颜色 + 动效，色弱用户可凭形状辨认。</span></p>
...
<tr><td><strong><span data-i18n="status-matrix:text.028">已锁定</span></strong><span data-i18n="status-matrix:text.029"> · Locked</span></td><td><span class="sm-dot sm-locked"><span data-i18n="status-matrix:text.030">受保护</span></span></td><td><code>--aw-text-2</code></td><td><span data-i18n="status-matrix:text.031">管理员手动锁机</span></td><td><span data-i18n="status-matrix:text.032">仅解锁；其余全部禁用</span></td></tr>
...
<tr><td><strong><span data-i18n="status-matrix:text.043">已退役</span></strong><span data-i18n="status-matrix:text.044"> · Decommissioned</span></td><td><span class="sm-dot sm-decom"><span data-i18n="status-matrix:text.045">下线</span></span></td><td><code>--aw-text-4</code></td><td><span data-i18n="status-matrix:text.046">资产已注销</span></td><td><span data-i18n="status-matrix:text.047">仅审计查看</span></td></tr>
  ...
  <div class="subsection">
    ...
    <p class="lede" style="margin-bottom:12px"><span data-i18n="status-matrix:text.049">这些状态用于列表、卡片、详情和结果页。这里只定义状态族与操作可用性，不定义状态转换图。</span></p>
    <table class="blueprint-table">
      ...
      <tbody>
        ...
        <tr><td><span data-i18n="status-matrix:text.066">设备连接</span></td><td><span data-i18n="status-matrix:text.067">在线 / 离线 / 锁定 / 故障 / 维护中</span></td><td><span data-i18n="status-matrix:text.068">数据中心、设备地图</span></td><td><span data-i18n="status-matrix:text.069">离线禁用远程控制；锁定只允许解锁；故障优先诊断与日志。</span></td></tr>
