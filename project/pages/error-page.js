...
<div class="ep-code">ERROR · 404</div>
<h4>页面不存在</h4>
<p class="ep-sub">请检查 URL，或从左侧菜单重新进入。如果是分享链接已失效，请联系发送者。</p>
<div style="display:flex;gap:8px"><button class="btn btn-primary">返回首页</button><button class="btn">联系管理员</button></div>
    </div>
    <div class="errorpage-card">
...
<div class="ep-code">ERROR · 403</div>
<h4>无权限访问</h4>
<p class="ep-sub">该页面需要 <code>device.manage</code> 权限。请联系空间管理员申请，或切换组织。</p>
<div style="display:flex;gap:8px"><button class="btn btn-primary">申请权限</button><button class="btn">切换组织</button></div>
    </div>
    <div class="errorpage-card">
...
<div class="ep-code">ERROR · 500</div>
<h4>服务异常</h4>
<p class="ep-sub">服务端发生未知错误。Trace ID：<code>5f3a-91bc-4422</code> · 请复制后联系运维。</p>
<div style="display:flex;gap:8px"><button class="btn btn-primary">重试</button><button class="btn">复制 Trace ID</button></div>
    </div>
  </div>
</section>
</div>
