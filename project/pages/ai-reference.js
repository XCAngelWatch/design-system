...
<div class="content">
  ...
  <section class="section">
    ...
    <div class="demo-grid cols-3" style="margin-top:18px">
      ...
      <div class="surface"><div class="tag-meta" data-i18n="ai-reference:scene.session.meta">设备诊断 / 远控</div><h3 data-i18n="ai-reference:scene.session.title">安全会话与审计</h3><p><span data-i18n="ai-reference:scene.session.prefix">优先看</span> <a href="#/device-center-page">DeviceCenterPage</a><span data-i18n="ai-reference:sep">、</span><a href="#/progress">Progress</a><span data-i18n="ai-reference:scene.session.suffix">。会话状态独立于推送批次，并保留操作者和日志。</span></p></div>
      <div class="surface"><div class="tag-meta" data-i18n="ai-reference:scene.assignment.meta">分配 / 冲突</div><h3 data-i18n="ai-reference:scene.assignment.title">范围、覆盖与部分成功</h3><p><span data-i18n="ai-reference:scene.assignment.prefix">优先看</span> <a href="#/tree-list">TreeList</a><span data-i18n="ai-reference:sep">、</span><a href="#/cascader">Cascader</a><span data-i18n="ai-reference:sep">、</span><a href="#/avatar-result">Result</a><span data-i18n="ai-reference:scene.assignment.suffix">。冲突必须显示来源，覆盖必须有独立权限。</span></p></div>
    </div>
  </section>
