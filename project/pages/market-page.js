    ...
    <div class="bp-shell">
      ...
      <div class="bp-shell-body">
        ...
        <div class="bp-main">
          ...
          <table class="dt">
            <thead><tr><th><span data-i18n="market-page:text.032">应用</span></th><th><span data-i18n="market-page:text.033">机构</span></th><th><span data-i18n="market-page:text.034">包名</span></th><th class="colnum"><span data-i18n="market-page:text.035">版本总数</span></th><th class="colnum"><span data-i18n="market-page:text.036">下载总数</span></th><th class="colactions"><span data-i18n="market-page:text.037">操作</span></th></tr></thead>
            <tbody>
              <tr><td><b>Terminal Guard</b></td><td><span data-i18n="market-page:text.038">华北运营中心</span></td><td><code>com.aw.guard</code></td><td class="colnum"><span class="mono">12</span></td><td class="colnum"><span class="mono">8,642</span></td><td class="colactions"><button class="btn btn-link btn-sm"><span data-i18n="market-page:text.039">详情</span></button><button class="btn btn-link btn-sm"><span data-i18n="market-page:text.040">版本</span></button><button class="btn btn-link btn-danger-link btn-sm"><span data-i18n="market-page:text.041">下架</span></button></td></tr>
              <tr><td><b>Policy Sync</b></td><td><span data-i18n="market-page:text.042">华南运营中心</span></td><td><code>com.aw.policy</code></td><td class="colnum"><span class="mono">8</span></td><td class="colnum"><span class="mono">3,210</span></td><td class="colactions"><button class="btn btn-link btn-sm"><span data-i18n="market-page:text.044">编辑</span></button><button class="btn btn-link btn-sm"><span data-i18n="market-page:text.043">审核</span></button><button class="btn btn-link btn-danger-link btn-sm"><span data-i18n="market-page:text.045">驳回</span></button></td></tr>
              <tr><td><b>Device Tools</b></td><td><span data-i18n="market-page:text.046">华东运营中心</span></td><td><code>com.aw.tools</code></td><td class="colnum"><span class="mono">5</span></td><td class="colnum"><span class="mono">1,088</span></td><td class="colactions"><button class="btn btn-link btn-sm"><span data-i18n="market-page:text.047">详情</span></button><button class="btn btn-link btn-sm"><span data-i18n="market-page:text.048">重新上架</span></button></td></tr>
            </tbody>
          </table>
        </div>
      </div>
