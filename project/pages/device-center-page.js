...
<section class="section" id="device-center-page">
  ...
  <div class="subsection">
    ...
    <div class="bp-grid">
      ...
      <div class="bp-card"><h4><span data-i18n="device-center-page:text.083">远程控制 16 指令</span></h4><p><span data-i18n="device-center-page:text.084">软件信息 · 流量控制 · 设备日志 · 应用安装 · 应用卸载 · 设备密码 · 设备锁定 · 全部刷新 · 恢复出厂 · WIFI 设置 · 调试开关 · 清警告 · 蓝牙开关 · 修改型号 · 消息通知 · 查找设备 · logcat。仅在线开放,每项复用推送引擎生成推送任务。</span></p></div>
  ...
  <div class="subsection">
    ...
    <table class="blueprint-table">
      ...
      <tbody>
        ...
        <tr><td><span data-i18n="device-center-page:text.104">锁定</span></td><td><span data-i18n="device-center-page:text.105">解锁、查看审计</span></td><td><span data-i18n="device-center-page:text.106">安装应用、OTA、恢复出厂</span></td><td><span data-i18n="device-center-page:text.107">锁定是保护态，不是错误态。</span></td></tr>
      </tbody>
    </table>
  </div>

  <div class="subsection">
    <h3><span data-i18n="device-center-page:text.108">组件映射</span></h3>
