...
<section class="section" id="page-header">
    ...
    <div class="ph-anatomy">
      ...
      <div class="ph-row ph-titlerow">
        <div>
          ...
          <div class="ph-slot" data-slot="keyFields" style="margin-top:6px;font-size:12px;color:var(--aw-text-3)">SN <code>DEV-86420075</code><span data-i18n="page-header:text.018"> · 上海 / 黄浦营业厅 · v3.4.2</span></div>
        </div>
    ...
    <div class="demo-grid cols-2">
      <div class="surface" style="padding:0">
        ...
        <div class="ph-mock">
          ...
          <div class="ph-tm">
            <div><b><span data-i18n="page-header:text.050">全部设备</span></b></div>
      ...
      <div class="surface" style="padding:0">
        ...
        <div class="ph-mock">
          ...
          <div class="ph-tm">
            <div><b><span data-i18n="page-header:text.055">终端-上海-001</span></b> <span class="status-dot online"><span data-i18n="page-header:text.056">在线</span></span></div>
      ...
      <div class="surface" style="padding:0">
        ...
        <div class="ph-mock">
          ...
          <div class="ph-tm">
            <div><b><span data-i18n="page-header:text.060">新建设备</span></b></div>
      ...
      <div class="surface" style="padding:0">
        ...
        <div class="ph-mock">
          <div class="ph-tm" style="border-top:0">
            <div><b><span data-i18n="page-header:text.065">仪表盘</span></b></div>
  ...
  <div class="subsection">
    ...
    <table class="map-table">
      ...
      <tbody>
        <tr><td>0 ~ 60px</td><td><span data-i18n="page-header:text.076">完整态</span></td><td><span data-i18n="page-header:text.077">面包屑 + 标题 + 操作 + Tabs</span></td></tr>
        <tr><td>≥ 60px</td><td><span data-i18n="page-header:text.078">紧凑态 (sticky)</span></td><td><span data-i18n="page-header:text.079">面包屑隐藏 / 标题缩 14px / 仅保留主次操作 + Tabs</span></td></tr>
    ...
    <div class="demo-grid cols-2">
      <div class="surface" style="border-left:3px solid var(--aw-success)">
        ...
        <ul style="margin:0;padding-left:18px;font-size:13px;color:var(--aw-text-2);line-height:1.9">
          ...
          <li><span data-i18n="page-header:text.100">同一类型页面（List / Detail / Form / Dashboard）槽位一致，页头不添加副标题 / 描述</span></li>
