...
<div class="wizard-mock">
  ...
  <div class="body">
    ...
    <div class="form-demo" style="max-width:none">
      ...
      <div class="form-row"><div class="lbl"><span data-i18n="wizard-page:text.020">失败重试</span></div><div class="row"><button type="button" class="switch is-on" role="switch" aria-checked="true" aria-label="失败重试" data-i18n-aria-label="wizard-page:text.020"></button><span style="font-size:13px;color:var(--aw-text-2)"><span data-i18n="wizard-page:text.021">自动重试 3 次，间隔 5 分钟</span></span></div></div>
      <div class="form-row"><div class="lbl"><span data-i18n="wizard-page:text.022">低电量保护</span></div><div class="row"><button type="button" class="switch is-on" role="switch" aria-checked="true" aria-label="低电量保护" data-i18n-aria-label="wizard-page:text.022"></button><span style="font-size:13px;color:var(--aw-text-2)"><span data-i18n="wizard-page:text.023">电量低于 30% 跳过</span></span></div></div>
    </div>
  </div>
  <div class="bottom">
