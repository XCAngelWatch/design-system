...
<div class="login-mock">
  ...
  <div class="panel-right" style="position:relative">
    ...
    <div class="lr-form">
      ...
      <div class="lr-field"><label><span data-i18n="login-page:text.014">密码</span></label><div style="position:relative"><input class="input" type="password" value="••••••••" /><span style="position:absolute;right:10px;top:50%;transform:translateY(-50%);color:var(--aw-text-3);cursor:pointer">👁</span></div></div>
      <div class="lr-field"><label><span data-i18n="login-page:text.015">验证码</span></label><div class="row" style="gap:8px"><input class="input" placeholder="6 位字符" style="flex:1" data-i18n-placeholder="login-page:text.016" /><div style="width:100px;height:32px;background:linear-gradient(135deg,#E8F3FF,#CCDFF7);border:1px solid var(--aw-border-2);border-radius:6px;display:grid;place-items:center;font-family:var(--aw-font-mono);font-size:14px;color:var(--aw-primary);font-weight:600;letter-spacing:2px;cursor:pointer">7K2N9</div></div></div>
