...
| 模块 | 权威内容 | 文件 |
| --- | --- | --- |
| 设备 / 数据中心 | 设备列表列、详情 35 字段、详情 Tab、设备状态三字段(onlineFlag/state/registeredFlag)、远程控制 16 指令、参数模板字段 | `docs/ai-coding-design-reference.md` 数据中心段 + `pages/device-center-page.js` |
